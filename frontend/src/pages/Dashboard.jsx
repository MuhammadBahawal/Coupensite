...
export const Dashboard = (props) => {
  ...
  function getTotalCoupons() {
    axios
      .post(
        `${window.location.origin}/coupon/fetchUserCoupons`, {
        userId: userInfo._id,
      })
      .then((res) => {
  ...
  function getTotalUsedCoupons() {
    // axios
    //   .post(`${window.location.origin}/coupon/fetchRedeemedCouponsCount`, {
    //     userId: userInfo._id,
    //   })
    //   .then((res) => {
    //     console.log("User");
  ...
  function getRecentOrders() {
    axios
      .post(`${window.location.origin}/coupon/fetchRecentOrders`, {
        userId: userInfo._id,
      })
      .then((res) => {
  ...
  function getStaticDynamicCount() {
    axios
      .post(`${window.location.origin}/coupon/fetchStaticDynamicCouponsCount`, {
        userId: userInfo._id,
      })
      .then((res) => {
        console.log(res);
